...
public class EditorTab extends JPanel {
	...
	public EditorTab(CharacterInterpreter ci, File originalFile, File translatedFile) {
		...
		TextList originalData = new TextList(originalText, null, false);
		translatedData = new TextList(translatedText, null, true);
